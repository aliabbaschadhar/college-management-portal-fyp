  ...
  return (
    <SignIn 
      appearance={{
        baseTheme: dark,
        elements: {
          card: "bg-zinc-950/40 backdrop-blur-xl border border-white/10 shadow-2xl rounded-2xl",
          ...
          formButtonPrimary: "bg-primary hover:bg-primary/90 text-primary-foreground transition-all duration-200 shadow-[0_0_20px_rgba(59,130,246,0.3)]",
